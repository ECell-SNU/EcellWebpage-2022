  ...
  return (
    <div className="TeamPageWrapper">
      ...
      <div className="SectionWrapper">
        ...
        <div className="TeamPageWrapper__grid">
          <div className="TeamPageWrapper__grid__members">
            <img className="TeamPageWrapper__grid__members__Image" src={sample1}></img>
            <div className="TeamPageWrapper__grid__members__Name">Pratham Agarwal</div>
            <h4 className="TeamPageWrapper__grid__members__Pos">Web Development</h4>
          </div>

          <div className="TeamPageWrapper__grid__members">
            <img className="TeamPageWrapper__grid__members__Image" src={sample1}></img>
            <div className="TeamPageWrapper__grid__members__Name">Lavanya Kaushik</div>
            <h4 className="TeamPageWrapper__grid__members__Pos">Content</h4>
          </div>
          <div className="TeamPageWrapper__grid__members">
            <img className="TeamPageWrapper__grid__members__Image" src={sample1}></img>
            <div className="TeamPageWrapper__grid__members__Name">Aryaman Gupta</div>
            <h4 className="TeamPageWrapper__grid__members__Pos">PR</h4>
          </div>
          <div className="TeamPageWrapper__grid__members">
            <img className="TeamPageWrapper__grid__members__Image" src={sample1}></img>
            <div className="TeamPageWrapper__grid__members__Name">Akshat Sabavat</div>
            <h4 className="TeamPageWrapper__grid__members__Pos">Web Development</h4>
          </div>
          <div className="TeamPageWrapper__grid__members">
            <img className="TeamPageWrapper__grid__members__Image" src={sample1} ></img>
        ...
        <div className="TeamPageWrapper__grid">
          <div className="TeamPageWrapper__grid__members">
            <img className="TeamPageWrapper__grid__members__Image" src={sample1} ></img>
            <div className="TeamPageWrapper__grid__members__Name">Nirmit Jindal</div>
            <h4 className="TeamPageWrapper__grid__members__Pos">Videography</h4>
          </div>
          <div className="TeamPageWrapper__grid__members">
            <img className="TeamPageWrapper__grid__members__Image" src={sample1}></img>
            <div className="TeamPageWrapper__grid__members__Name">John Smith</div>
